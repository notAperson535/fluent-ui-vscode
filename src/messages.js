exports.messages = {
	...
	enabled:
		"Windows 11 for VSCode is enabled. Restart to take effect. " +
		"If VSCode says that it is corrupted, click more, and then click Don't Show Again.",
	disabled: "Windows 11 for VSCode disabled and reverted to default. Restart to take effect.",
	already_disabled: "Windows 11 for VSCode already disabled.",
